...
Полная документация проекта размещена в директории [`/docs/`](docs/):

- **[API Справочники](docs/api/)** - Детальные руководства по API и преобразованиям
- **[Рабочие процессы](docs/workflows/)** - Пошаговые инструкции и диаграммы
- **[Устранение проблем](docs/troubleshooting/)** - Решения частых проблем и отладка
- **[Заметки разработчика](docs/notes/)** - История версий и заметки

## 🔗 Дополнительные ресурсы
- Примеры скриптов см. на [**данной страничке**](https://github.com/GeorgGrebenyuk/RengaDyn/wiki/4.-Отдельные-скрипты)
- Расширенную справку читай в [Wiki-разделе](https://github.com/GeorgGrebenyuk/RengaDyn/wiki)
- Курс "Renga API - Программирование"
